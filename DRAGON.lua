...
{'تنظيف المجموعـات ℘','تنظيف المشتركين ℘'},
{'جلب نسخه الاحتياطيه ℘'},
...
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/SIRIA199"}},
}
...
if text == "تنظيف المجموعـات ℘" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n ℘︙ تم الغاء (الحظر-الكتم) عام من المجموعـات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
'\n ℘︙  علامة ال {🔓} تعني مفعل'..
'\n ℘︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 ??𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ'..
'\n ℘︙  الروابط » { '..lock_links..
' }\n'..' ℘︙  المعرفات » { '..lock_user..
' }\n'..' ℘︙  التاك » { '..lock_hash..
' }\n'..' ℘︙  البوتات » { '..lock_bots..
