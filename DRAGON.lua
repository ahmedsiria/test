...
local UserName = (data.username_ or "Klosha28")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩ＫＬＯＳＨＡ𓆪.")  
...
{'ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ'},
{'قناة السورس'},
{'ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ'},
{'تويت','صراحه'},
{'ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ'},
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/test/main/DRAGON.lua')
...
usertext = '\n♡︙ العضو » ['..result.title_..'](t.me/'..(username or 'Klosha28')..')'
status  = '\n♡︙ تم ترقيته مطور'
...
usertext = '\n♡︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Klosha28')..')'
status  = '\n♡︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'♡︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Klosha28')..') \n♡︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"♡︙ العضو : {["..data.first_name_.."](T.ME/Klosha28)}\n♡︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "♡︙ عذرا » {["..data.first_name_.."](T.ME/Klosha28)}\n♡︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
✨  𝑾𝑬𝑳𝑪𝑶𝑴 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 ＫＬＯＳＨＡ  ✨
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' KLOSHA℡  ',url="t.me/KLOSHa2"}},
{{text = ' ℡BAR KLOSHA  ',url="t.me/Klosha28"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'♡︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Klosha28')..') \n♡︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'♡︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Klosha28')..') \n♡︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n♡︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Klosha28')..')'
status  = '\n♡︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n♡︙ العضو » '..userid..''
...
t = "\n♡︙ قائمة محظورين الكروب \nٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ??ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
'\nءٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ'..
'\n♡︙  علامة ال {🔓} تعني مفعل'..
'\n♡︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ'..
'\n♡︙  الروابط » { '..lock_links..
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n♡︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Klosha28')..')'..'\n♡︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 ＫＬＯＳＨＡ.',url="t.me/Klosha28"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."Klosha28:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Klosha28:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Klosha28:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Klosha28:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Klosha28:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Klosha28:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Klosha28')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/Klosha28"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━━━  ＫＬＯＳＨＡ 𖠱²² ━━━━━━⩺\n℘︙ ➫ .[ ❍ ┇𓆩ＫＬＯＳＨＡ𓆪. ](t.me/Klosha28)➤ ')
end
...
🍁الاشعارات
⩹━━━━━━  ＫＬＯＳＨＡ 𖠱²² ━━━━━━⩺
[🍁S O R C E  ＫＬＯＳＨＡ 𖠱²² 🍁](t.me/Klosha28)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🍁صورتي 
⩹━━━━━━  ＫＬＯＳＨＡ 𖠱²² ━━━━━━⩺
[🍁S O R C E  ＫＬＯＳＨＡ 𖠱²² ⚡️](t.me/Klosha28)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
⩹━━━━━━  ＫＬＯＳＨＡ 𖠱²² ━━━━━━⩺
[🗯️ S O R C E  ＫＬＯＳＨＡ 𖠱²² 🗯️](t.me/Klosha28)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'S O R C E  ＫＬＯＳＨＡ 𖠱²²', url="t.me/Klosha28"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Klosha28)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Klosha28)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Klosha28)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/Klosha28)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/Klosha28)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/Klosha28)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Klosha28)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/Klosha28)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/Klosha28)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/Klosha28)') 
return false
end
end
end
...
if text == 'سوريا' or text == 'احمد' or text == 'س' then
local Text = [[
...
if text == 'كلوشا' or text == 'كالوشه' or text == 'كلوشه' then
local Text = [[
𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'صـاحب السورس',url="t.me/KLOSHa2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
